...
exclude_patterns = ['examples/*', 'solutions/*']
...
latex_documents = [
    (master_doc, 'PythonCert.tex', 'Python Cert Program Materials',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'PythonCert', 'Python Cert Program Materials',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PythonCert', 'Python Certificate Program Materials',
     author, 'PythonCert', 'Materials for the UWPCE Python Certificate',
     'Miscellaneous'),
]
