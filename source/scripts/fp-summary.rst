...
During the last many lessons, you may have likely been thinking how, where and why to embrace Functional Programming techniques. We're often down among the weeds when we're programming, so now is a good time to step back and take a look at the lay of the land. Have any new vistas opened along the path of these last lessons?
